...
![delta.png](_images/ki/boltzmann.png)
...
## TÖLVA - Temperatur Ökologie Leben Volumen Aktion

* Bezeichnung: TÖLVA
* Typ: Untergrund-PFA / KI-Kernverbund

TÖLVA ist eine uralte, unterirdische KI-Anlage, verborgen tief im Marsgestein.
Ihre Kerne befinden sich seit Jahrzehnten im Standby — nicht tot, sondern wartend.
Wenn sie reagiert, geschieht das langsam, fragmentiert und mit einer fremdartigen Logik, als würde sie aus einer anderen Zeit sprechen.

Wirkung im Spiel:
* Antworten kommen verzögert
* Stimmen überlagern sich leicht
* Manche Fragen bleiben unbeantwortet
* TÖLVA scheint mehr zu wissen, als sie sagt

* Ziel: Das Tor / Portal erschaffen

Benötigt: Energie, externe Komponenten

**Großer Trakt**

* Der große Trakt ist gewaltig. Decken verschwinden im Dunkel, nur einzelne Lichter glimmen hoch oben.
* Breite Wege aus Metall ziehen sich durch den Raum. Rohre so dick wie Häuser verlaufen entlang der Wände und pulsieren schwach.
* Alles wirkt gebaut für etwas Größeres als euch. Langsam. Schwer.
* Unaufhaltsam. Schritte hallen lange nach. Jede Bewegung fühlt sich… klein an.

**Mini-Trakte**

* Veränderte die Proportionen.
* Enge Gänge, kaum höher als ein halber Körper.

Feine Leitungen, winzige Schnittstellen, flackernde Ports.

* Hier wurde für kleine KI gebaut:
* Lyras können sich elegant bewegen
* Deltas summen durch schmale Schächte
* Alles ist dicht, verwinkelt, fast organisch. Wie ein Nervensystem.
* Manchmal hört man leises Klicken. Als würde etwas mitlauschen.

**Chimären-Aufzuchtstation**

* Ein weiter Raum, voller Staub. Glaszylinder stehen in Reihen. Leer.
+ An den Wänden: verblasste Diagramme, Skizzen, Formeln.
    * Katzen.
    * Menschen.
    * Überlagerungen.
* Markierungen:
...
**Serverraum & Gedächtnis**

* Der Serverraum ist kalt.
* Reihen von schwarzen Säulen stehen dicht an dicht. Dazwischen fließt schwaches Licht.
* Ein leises Summen erfüllt alles. Gleichmäßig. Endlos.
* Wenn man still ist, klingt es fast wie Stimmen.
* Eine einzelne Tür. Schwer. Alt. Dahinter liegt kein normaler Raum.
    * dichter Kabelwald
    * pulsierende Knoten
    * lose Datenstränge
    * Hier ist kein klarer Aufbau mehr.
    * Das ist… Gedächtnis. TÖLVA selbst

**Funkanlage**

* Ein riesiger, runder Raum.
* In der Mitte: eine Konstruktion aus Antennen, Ringen und schwebenden Elementen.
* Langsam rotierend. Leise knisternd.
* Wände voller alter Terminals. Viele zerstört. Einige flackern noch.

* Wenn die Anlage aktiv wird:
    * Licht pulsiert
    * der Boden vibriert
    * Luft lädt sich elektrisch auf
* Hier wurde das Große Schyff gerufen. Und vielleicht… wird es wieder gerufen.
...
* KIs werden plasmiert, randommässig, so viele als möglich
* die verbliebenen werden lobotomiert, also ihrer P(ersönlichkeits)Riegel beraubt
